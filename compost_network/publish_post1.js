...
"<a title='Click to access users Profile page' style='color:black;' href='profile.html?id=" + comment_userid +"' title='Click to access users page'>"+
...
"<button class='post_css1'><a title=' Send Friends Request' style='color:black;' id='request_"+postid+"_"+comment_userid+"' class='send_request'><span style='font-size:20px;color:#3b5998;' class='fa fa-comments-o'></span></a></button></div>"+
